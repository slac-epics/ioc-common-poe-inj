...
epicsEnvSet( "IOCTOP",       "/u/at/sgess/controls_work/ioc-common-poe-inj" )
epicsEnvSet( "BUILD_TOP",    "/u/at/sgess/controls_work/ioc-common-poe-inj" )
...
# Register all support components
dbLoadDatabase("dbd/poe-inj.dbd")
poe_inj_registerRecordDeviceDriver(pdbbase)
...
dbLoadRecords( "db/poe-inj.db", "HOST=poe-b34-ex01,PRE=TST:POE:01" )

#epicsEnvSet( "DEV_INFO", "DEV=TST:POE:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
#epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=poe-b34-ex01" )
...
read_mib( "$(IOCTOP)/mibs/SNMP-FRAMEWORK-MIB.txt" )
read_mib( "$(IOCTOP)/mibs/POWER-ETHERNET-MIB.MIB" )

#Snmp2cWalk("poe-b34-ex01", "write", "ICT-MIB::deviceModel", 95, 2.0)

Snmp2cWalk("poe-b34-ex01", "public", "POWER-ETHERNET-MIB::pethMainPseConsumptionPower", 3, 2.0)
#Snmp2cWalk("poe-b34-ex01", "public", "POWER-ETHERNET-MIB::pethMainPseOperStatus", 3, 2.0)
#Snmp2cWalk("poe-b34-ex01", "public", "POWER-ETHERNET-MIB::pethMainPseAdminEnable", 3, 2.0)
